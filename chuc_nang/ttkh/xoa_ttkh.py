...
def xoa():
    ...
    try:
        cursor.execute("delete from ttkh WHERE id = %s", (id,))
        conn.commit()
...
root = tk.Tk()
root.title("Xóa Thông Tin Khách Hàng")
root.geometry("400x300")

tk.Label(root, text="Xóa Thông Tin Khách Hàng", font=('Arial', 14, 'bold')).grid(row=0, column=0, columnspan=2, pady=10)
