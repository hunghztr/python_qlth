...
def sua_ghe_ngoi():
    ...
    try:
        cursor.execute("update ghe_ngoi set tinh_trang = %s , id_toa = %s where id = %s", (tinh_trang,id_toa, id))
        conn.commit()
...
btn_edit = tk.Button(root, text="Sửa", width=15, font=('Arial', 12, 'bold'), bg="#4CAF50", fg="white")
