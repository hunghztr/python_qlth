...
def xoa():
    ...
    try:
        cursor.execute("delete from lich_trinh where id = %s", (id,))
        conn.commit()
...
root = tk.Tk()
root.title("xóa Lịch Trình")
root.geometry("400x350")

tk.Label(root, text="Xóa Lịch Trình", font=('Arial', 14, 'bold')).grid(row=0, column=0, columnspan=2, pady=10)
